...
### Added
- **Debuff base durations (timed backstop)**: Packet-detected debuffs now record a base duration so a missed removal packet can't keep the tracked status alive forever. Durations: Sleep 90s, Poison/Paralyze/Blind/Silence/Dia/Bio 120s, Petrify 60s, Stun 10s, Bind 60s, Gravity 90s, Slow 180s, Doom/Terror 30s, Amnesia/Addle 180s; Curse/Bane/Disease/Plague never time out; any other erasable debuff defaults to 120s.
