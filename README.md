...
### Changed
- **All automation now pauses while moving**: Sidekick now blocks all automated actions while the player is moving, not just spell casts, so movement no longer causes interrupted or partially-started support actions.
