...
return {
    ...
    abilities = {
        ...
        -- its own. Opt-in (pet_control_enabled, off by default); the <t>/<bt>
        -- target and its gate come from pet_control_target, applied in
        -- pet.execute_deploy (lib/actions/pet.lua) -- the <t> here is the
        -- default, rewritten to <bt> there when that mode is picked. When both
        -- main and sub job supply a pet_control entry, execute always reads index
